...
public class ParamsX
{
  ...
  // STATIC BOOLEAN
    ...
    {
        return(
            (Boolean)get(req, name, Boolean.class)
        );
    }
    ...
    {
        return(
            (Boolean)need(req, name, Boolean.class)
        );
    }

    public static Boolean[] getBooleanArray(HttpServletRequest req, String name)
    {
        return(
            (Boolean[])get(req, name, Boolean[].class)
        );
    ...
    public static Boolean[] needBooleanArray(HttpServletRequest req, String name)
    {
        return(
            (Boolean[])need(req, name, Boolean[].class)
        );
