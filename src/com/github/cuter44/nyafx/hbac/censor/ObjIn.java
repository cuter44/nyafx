...
public class ObjIn extends DefaultCensorSupport
  ...
  // CENSOR
    ...
    public Criteria acCriteria(Criteria c, Object sub, Class<? extends Object> objClass, Rule rule)
    {
        try
        {
            ...
            String p = super.getString(rule.config, KEY_OBJ_PROP);
            String hql = super.getString(rule.config, KEY_REFERENCE);
            ...
            else
            {
                ...
                subc.add(Restrictions.in(pa[pa.length-1], r));
            }
